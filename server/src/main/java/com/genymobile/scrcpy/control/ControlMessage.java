...
public final class ControlMessage {
    ...
    public static final int TYPE_UHID_CREATE = 17;
    public static final int TYPE_UHID_INPUT = 18;
    public static final int TYPE_UHID_DESTROY = 19;
    public static final int TYPE_OPEN_HARD_KEYBOARD_SETTINGS = 20;
