...
public class SurfaceEncoder implements AsyncProcessor {
    ...
    private void streamCapture() throws IOException, ConfigurationException {
        ...
        try {
            streamer.writeVideoHeader(capture.getSize(), capture.getDevice().getScreenInfo().getDeviceRotation());
            Ln.d("start write banner");
//            streamer.writeBanner(capture.getDevice());
            boolean alive;
